        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentCategoryName = table.Column<string>(type: "nvarchar(32)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Categories", x => x.Name);
                    table.ForeignKey(
                        name: "FK_Categories_Categories_ParentCategoryName",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentProducts", x => new { x.RentId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_ParentCategoryName",
                table: "Categories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentProducts_ProductId",
                table: "RentProducts",
                column: "ProductId");
